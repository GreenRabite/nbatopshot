...
const runFunction = async () => {
  ...
  const wednesdayAssistLeader = sortPlayersByAttribute(_.clone(wednesdayPlayers), 'assists')
  const wednesdayFGMLeader = sortPlayersByAttribute(_.clone(wednesdayPlayers), 'fgm')
  ...
  const markdown = [
    ...
    `## Assists Leader`,
    ...standingsByAttribute(wednesdayAssistLeader, 'assists'),
    `## FGM Leader`,
    ...standingsByAttribute(wednesdayFGMLeader, 'fgm'),
